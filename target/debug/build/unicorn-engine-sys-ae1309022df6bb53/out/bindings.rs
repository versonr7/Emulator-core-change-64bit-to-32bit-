...
unsafe extern "C" {
    pub fn uc_mem_map(uc: *mut uc_engine, address: u64, size: u64, perms: u32) -> uc_error;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn uc_mem_unmap(uc: *mut uc_engine, address: u64, size: u64) -> uc_error;
}
unsafe extern "C" {
    pub fn uc_mem_protect(uc: *mut uc_engine, address: u64, size: u64, perms: u32) -> uc_error;
}
unsafe extern "C" {
